    ...
    return (
        <footer className="pt-20 md:pt-32 pb-12 md:pb-16 px-6 border-t-8 border-black text-center bg-white">
            <div className="flex flex-col justify-center items-center gap-6 mb-12">
                ...
                <span className="text-3xl md:text-5xl font-black tracking-tighter text-black uppercase italic">Catalyst</span>
            </div>
            <div className="space-y-6">
                <p className="text-black text-[10px] md:text-sm font-black uppercase tracking-[0.2em] px-4 leading-relaxed max-w-md mx-auto italic">
