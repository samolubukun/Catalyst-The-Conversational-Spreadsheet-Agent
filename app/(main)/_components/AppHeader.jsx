            ...
            <div className='flex items-center gap-2 sm:gap-3 md:gap-5 min-w-0'>
                ...
                {isWorkspace && (
                    <div className="flex items-center gap-1.5 sm:gap-2 md:gap-3 min-w-0">
                        ...
                        >
                            <SelectTrigger className="w-[140px] xs:w-[160px] sm:w-[190px] lg:w-[240px] bg-slate-100 dark:bg-slate-900 border-border hover:bg-slate-200 dark:hover:bg-slate-800 transition-colors shadow-sm focus:ring-emerald-500 text-[11px] sm:text-xs font-medium h-9 min-w-0">
                ...
                {userData && (
                    <div className="flex items-center gap-1.5 bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 px-2 sm:px-3 py-1 rounded-full text-[10px] sm:text-xs font-bold text-slate-700 dark:text-slate-300 shadow-sm shrink-0 select-none">
                        <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span>
                        <span>{userData.credits ?? 0}<span className="hidden sm:inline"> Credits</span></span>
                    </div>
                )}
